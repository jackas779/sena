...
<div class="card">
    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3">
                    <h3 class="m-0 font-weight-bold" style="color: black;">Crear marca</h3>
                    <hr>
       ...
       <form action="neg_dat_crear_marcas.php" method="post" autocomplete="off" name="crear_categorias" align="center">
        ...
        <div class="form-group w-25">
                  <input  class="form-control form-control-user"type="text" id="nombre" name="nombre" required placeholder="Nombre">
        </div>
        <hr class="w-25">
        ...
        <span class="text-dark"> <b> Crear Marca</b></span></a></button>
       </form>
   </div>
